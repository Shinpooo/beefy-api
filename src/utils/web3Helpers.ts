...
const MULTICALLS: Record<ChainId, Pick<BeefyFinance, 'multicall'>['multicall']> = {
  ...
  [ChainId.velas]: addressBookByChainId[ChainId.velas].platforms.beefyfinance.multicall,
};
...
clients.velas.push(new Web3(VELAS_RPC));
...
export const chainRandomClients = {
  ...
  velasRandomClient: () => clients.velas[~~(clients.velas.length * Math.random())],
};
